        ...
        <div>
            ...
            <div class="mt-12">
                ...
                <div class="grid grid-cols-2 grid-flow-row gap-4">
                    ...
                    <input type='date' class="w-full p-3 mt-2 bg-white border border-gray-200 rounded-lg"
                        placeholder="Enter date of birth">
                    <input type='email' class="w-full p-3 mt-2 bg-white border border-gray-200 rounded-lg"
                        placeholder="Enter email address">
                    <select id="country" name="country" class="w-full p-3 mt-2 bg-white border border-gray-200 rounded-lg">
                    ...
                    <input type='tel' class="w-full p-3 mt-2 bg-white border border-gray-200 rounded-lg"
